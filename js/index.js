...
more1.onclick = () => {
  if (window.innerWidth < 600) {
    ...
    if (post1.style.height === "700px") {
      post1.style.height = "350px";
      right1.style.top = "0"; // Mova o menu para baixo
      right1.style.left = "-350px"; // Alinha à esquerda
      ...
      more1.style.width = "350px";
    } else {
      post1.style.height = "700px";
      right1.style.top = "350px"; // Mova o menu para baixo
      right1.style.left = "-350px"; // Alinha à esquerda
...
const fileLink1 =
  "https://drive.google.com/uc?export=download&id=1SUTuepkhf66wg7dtmCb55tr55zbZb76l";
...
const initTimer1 = () => {
  ...
  downloadBtn1.innerHTML =
    '<span class="text2">Your file is downloading...</span>';
  setTimeout(() => {
...
more4.onclick = () => {
  if (window.innerWidth < 600) {
    // Para telas menores que 600px
    if (post4.style.height === "700px") {
      post4.style.height = "350px";
      right4.style.top = "0"; // Mova o menu para baixo
      right4.style.left = "-350px"; // Alinha à esquerda
      ...
      more4.style.width = "350px";
    } else {
      post4.style.height = "700px";
      right4.style.top = "350px"; // Mova o menu para baixo
      right4.style.left = "-350px"; // Alinha à esquerda
...
const fileLink6 =
  "https://drive.google.com/uc?export=download&id=1mU7J5pa4e-r2VjgKCXcbc9dCAwn2tzth";
...
more3.onclick = () => {
  if (window.innerWidth < 600) {
    // Para telas menores que 600px
    if (post3.style.height === "700px") {
      post3.style.height = "350px";
      right3.style.top = "0"; // Mova o menu para baixo
      right3.style.left = "-350px"; // Alinha à esquerda
      ...
      more3.style.width = "350px";
    } else {
      post3.style.height = "700px";
      right3.style.top = "350px"; // Mova o menu para baixo
      right3.style.left = "-350px"; // Alinha à esquerda
...
const fileLink7 =
  "https://drive.google.com/uc?export=download&id=1n_SyujubpwlXWsFqcfuQKjbAXLLEi8Of";
