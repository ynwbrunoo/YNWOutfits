...
<body>
    ...
    <header id="header" class="flexbox">
        <div class="header-wrapper flexbox">
          <h1 class="header-title">YNW BSLIME</h1>
          <h1 class="header-warning">This page only works on pc</h1>
          <div class="header-overlay"></div>
          <img class="header-image" src="img/ynw-bslime.gif">
        </div>
    </header>
    <main class="flexbox-col">
        <div class="titlesinger titlesinger2" id="ynwbslime-title">
            <h1 id="ynwbslime-h1">YNW BSLIME</h1>
        ...
        <div class="ynwmusic">
            <iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/3hQxRNvyo1jA9qV55Mu0EJ?utm_source=generator&theme=0" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
        </div>
        <div id="gpost2">
        ...
        <div id="gpost3">
            <div class="post" id="post3">
                <div class="left">
                    <div class="image5" id="img5">
                        <div class="vest-click displayNone" id="vest-click23" onClick="window.open('https://watchmydiamonds.com/rolex-mens-datejust-ii-41mm-stainless-steel-green-roman-diamond-dial-custom-fully-iced-out-watch.html');">
                            <div class="vest-img">
                                <img src="img/hoddie1.jpg">
                            </div>
                            <div class="desc-click">
                                <p><b>Givenchy</b></p>
                        ...
                        <div class="vest-click displayNone" id="vest-click24" onClick="window.open('https://www.mrporter.com/en-us/mens/product/givenchy/clothing/sweatpants/slim-fit-logo-embroidered-cotton-jersey-sweatpants/30629810020329916');">
                            <div class="vest-img">
                                <img src="img/pants4.jpg">
                            </div>
                            <div class="desc-click">
                                <p><b>Givenchy</b></p>
                                <p>Track Pants</p>
                        ...
                        <div class="vest-click displayNone" id="vest-click25" onClick="window.open('https://www.cettire.com/products/givenchy-spectre-low-top-sneakers-94561003');">
                            <div class="vest-img">
                                <img src="img/sneakers5.jpg">
                            </div>
                            <div class="desc-click">
                                <p><b>Givenchy</b></p>
                                <p>Zip Black Sneakers</p>
                                <p><span>$717</span></p>
                            </div>
                        </div>
                        <div id="btnA5">
                            <button id="btn23" class="btn"></button>
                            <button id="btn24" class="btn"></button>
                            <button id="btn25" class="btn"></button>
                        </div>
                    </div>
                </div>
                <div class="right" id="right3">
                    <div class="outfit">
                        ...
                        <div class="vest" onClick="window.open('https://www.mrporter.com/en-us/mens/product/givenchy/clothing/sweatpants/slim-fit-logo-embroidered-cotton-jersey-sweatpants/30629810020329916');">
                            <div class="vest-img">
                                <img src="img/pants4.jpg">
                            </div>
                            <div class="desc">
                        ...
                        <div class="vest" onClick="window.open('https://www.cettire.com/products/givenchy-spectre-low-top-sneakers-94561003');">
                            <div class="vest-img">
                                <img src="img/sneakers5.jpg">
                            </div>
                            <div class="desc">
                        ...
                        <div class="download">
                            <button class="download-btn5" data-timer="10">
                                <span class="icon material-symbols-rounded">vertical_align_bottom</span>
                                <span class="text">Download Image</span>
                            </button>
                        </div>
...
$(document).ready(function() {
  ...
  $(window).scroll(function() {
    ...
    ScrollReveal({
          ...
          ScrollReveal().reveal("#gpost2", { delay: 100, origin: 'left'});
          ScrollReveal().reveal("#gpost3", { delay: 100, origin: 'right'});
          ScrollReveal().reveal("#gpost4", { delay: 100, origin: 'left'});
...
let vestClick23 = document.getElementById("vest-click23");

btn23.onclick = () => {
    vestClick23.classList.toggle('displayNone');
    vestClick24.classList.add('displayNone');
    vestClick25.classList.add('displayNone');
}

let btn24 = document.getElementById("btn24");
let vestClick24 = document.getElementById("vest-click24");

btn24.onclick = () => {
    vestClick23.classList.add('displayNone');
    vestClick24.classList.toggle('displayNone');
    vestClick25.classList.add('displayNone');
}

let btn25 = document.getElementById("btn25");
let vestClick25 = document.getElementById("vest-click25");

btn25.onclick = () => {
    vestClick23.classList.add('displayNone');
    vestClick24.classList.add('displayNone');
    vestClick25.classList.toggle('displayNone');
}
...
more3.onclick = () => {
    ...
    if(post3.style.width === "850px") {
        ...
        img5.style.borderRadius = "20px 20px 0px 0px";
        btn23.style.visibility = "visible";
        btn24.style.visibility = "visible";
        btn25.style.visibility = "visible";
        vestClick23.style.visibility = "visible";
        vestClick24.style.visibility = "visible";
        vestClick25.style.visibility = "visible";
        vestClick23.style.opacity = "1";
        vestClick24.style.opacity = "1";
        vestClick25.style.opacity = "1";
        btnA5.style.opacity = "1";
        more3.innerText = "Show Details";
        more3.style.width = "500px";
    } else {
        post3.style.width = "850px";
        right3.style.left = "0";
        img5.style.borderRadius = "20px 0px 0px 0px";
        btn23.style.visibility = "hidden";
        btn24.style.visibility = "hidden";
        btn25.style.visibility = "hidden";
        vestClick23.style.visibility = "hidden";
        vestClick24.style.visibility = "hidden";
        vestClick25.style.visibility = "hidden";
        vestClick23.style.opacity = "0";
        vestClick24.style.opacity = "0";
        vestClick25.style.opacity = "0";
        btnA5.style.opacity = "0";
        more3.innerText = "Hide Details";
        more3.style.width = "850px";
    }
}

const downloadBtn5 = document.querySelector(".download-btn5");
const fileLink5 = "https://drive.google.com/uc?export=download&id=1nKFKRUTkqyNEsKvY1IVJem8EEEM-eP4_";

const initTimer5 = () => {
    if(downloadBtn5.classList.contains("disable-timer")) {
        return location.href = fileLink5;
    }
    location.href = fileLink5;
    downloadBtn5.innerHTML = '<span class="text2">Your file is downloading...</span>';
    setTimeout(() => {
        downloadBtn5.classList.add("disable-timer");
        downloadBtn5.innerHTML = `<span class="icon material-symbols-rounded">vertical_align_bottom</span>
                                 <span class="text">Download Again</span>`;
    }, 3000);
}

downloadBtn5.addEventListener("click", initTimer5);
