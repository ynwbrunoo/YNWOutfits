...
<body>
    ...
    <header id="header" class="flexbox">
        <div class="header-wrapper flexbox">
          <h1 class="header-title">YNW BORTLEN</h1>
          <h1 class="header-warning">This page only works on pc</h1>
          <div class="header-overlay"></div>
          <img class="header-image" src="img/ynw-bortlen.gif">
        </div>
    </header>
    <main class="flexbox-col">
        ...
        <div class="ynwmusic">
            <iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/55eY16Lyr4lrB9k67ADadL?utm_source=generator&theme=0" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
        </div>
        <div id="gpost3">
